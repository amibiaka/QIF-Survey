...
window.QI_I18N = {
 ...
 insights: {
  ...
  demo:{ en:"SAMPLE DATA", fr:"DONNÉES D'EXEMPLE", ar:"بيانات توضيحية" },
  demoNote:{ en:"Charts marked SAMPLE DATA use synthetic figures to preview the analytics. They contain no real survey responses.",
             fr:"Les graphiques marqués DONNÉES D'EXEMPLE utilisent des données synthétiques pour illustrer les analyses. Ils ne contiennent aucune réponse réelle.",
...
(function(){
  var X = {
   entry: {
    ...
    yourEmail:{ en:"Your email", fr:"Votre courriel", ar:"بريدك الإلكتروني" },
    emailWhy:{ en:"Required so you receive a confirmation file of your responses that you can keep and email to the coordinators. No password is created.",
               fr:"Requis pour recevoir un fichier de confirmation de vos réponses, à conserver et à transmettre par courriel aux coordonnateurs. Aucun mot de passe n'est créé.",
    ...
    confirmDocTitle:{ en:"Survey on Financing Quality Infrastructure and MSME Access to Finance — Response confirmation", fr:"Enquête sur le financement de l'infrastructure de la qualité et l'accès des MPME au financement — Confirmation de réponse", ar:"استبيان تمويل البنية التحتية للجودة ووصول المنشآت الصغرى والصغيرة والمتوسطة إلى التمويل — تأكيد الإجابة" },
    confirmIntro:{ en:"This document confirms the responses submitted through QIF Survey Master. You may keep it for your records and email it to the survey organisers (AUDA-NEPAD, UNIDO and the OACPS).", fr:"Ce document confirme les réponses envoyées via QIF Survey Master. Vous pouvez le conserver et l'envoyer par courriel aux organisateurs de l'enquête (AUDA-NEPAD, ONUDI et OEACP).", ar:"يؤكد هذا المستند الإجابات المُرسلة عبر QIF Survey Master. يمكنكم الاحتفاظ به وإرساله بالبريد إلى منظمي الاستبيان (أودا-نيباد واليونيدو والأواكبس)." },
    colQuestion:{ en:"Question", fr:"Question", ar:"السؤال" },
    colAnswer:{ en:"Your answer", fr:"Votre réponse", ar:"إجابتكم" },
    fRespondent:{ en:"Respondent", fr:"Répondant", ar:"المجيب" },
    fEmail:{ en:"Email", fr:"Courriel", ar:"البريد الإلكتروني" },
    fScope:{ en:"Country / coverage", fr:"Pays / couverture", ar:"البلد / التغطية" },
    fSubmitted:{ en:"Submitted", fr:"Envoyé le", ar:"تاريخ الإرسال" },
